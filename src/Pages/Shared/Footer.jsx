    ...
    <div className="bg-[#251621] text-[#FFFFFF] rounded-t-3xl">
      <footer className="footer grid grid-flow-col p-10">
        ...
        <div>
          ...
          <a className="link link-hover">+8801712512475</a>
        </div>
        <div>
          <span className="footer-title">Follow Us</span>
          <div className="">
            <div className="flex gap-4">
              <div className="border border-1 p-1 rounded-full w-6 h-6">
            ...
            <div>
              <p className="text-end pr-8 mt-14">© 2025 - Heavenix. All right reserved.</p>
            </div>
          </div>
        </div>
      </footer>
      <div>
        ...
        <div className="text-[180px] Alex font-semibold text-center  bg-gradient-to-r from-[#8A7384] to-[#CAC3C3] bg-clip-text text-transparent">WIZTECBD</div>
      </div>
    </div>
  );
};
